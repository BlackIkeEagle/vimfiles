...
" Magic Constants
syn keyword phpMagicConstants __LINE__ __FILE__ __DIR__ __FUNCTION__ __CLASS__ __METHOD__ __NAMESPACE__ __TRAIT__ contained
...
syn keyword phpClasses Collator NumberFormatter Normalizer Locale MessageFormatter IntlDateFormatter ResourceBundle Transliterator contained
...
" mhash
" mssql
syn keyword phpFunctions mssql_connect mssql_pconnect mssql_close mssql_select_db mssql_query mssql_fetch_batch mssql_rows_affected mssql_free_result mssql_get_last_message mssql_num_rows mssql_num_fields mssql_fetch_field mssql_fetch_row mssql_fetch_array mssql_fetch_assoc mssql_fetch_object mssql_field_length mssql_field_name mssql_field_type mssql_data_seek mssql_field_seek mssql_result mssql_next_result mssql_min_error_severity mssql_min_message_severity mssql_init mssql_bind mssql_execute mssql_free_statement mssql_guid_string contained
" mysql
...
" Class Keywords
syn keyword phpType class abstract extends interface implements static final var public private protected const callable insteadof trait contained
...
if exists("php_parent_error_close") && php_parent_error_close == 1
...
" Comment
if exists("php_parent_error_open") && php_parent_error_open == 1
...
syn match  phpDocCustomTags  "@\w\(\s\+\)\?" containedin=phpComment
...
syn match  phpDocTodo  "@\(todo\|fixme\|xxx\)\(\s\+\)\?" containedin=phpComment
