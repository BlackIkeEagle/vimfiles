...
if &background == "dark"
    ...
    exe "hi Statement    gui=italic guifg=".s:brown        ." gui=NONE"
    exe "hi Delimiter    guifg=".s:darkcyan     ." gui=NONE"
    exe "hi PreProc      guifg=".s:darkmagenta
    exe "hi Comment      gui=italic guifg=".s:darkblue
    exe "hi SpecialKey   gui=italic guifg=".s:darkmagenta
    ...
    exe "hi DiffText     gui=italic,bold guibg=".s:black
    ...
    exe "hi Special      gui=italic guifg=".s:darkcyan
