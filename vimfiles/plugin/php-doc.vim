...
let g:pdv_cfg_Author = AuthorName." <".AuthorEmail.">"
...
command! -n=0 -complete=dir -bar PhpDoc :call PhpDoc()
...
func! PhpDocFunc()
	...
	exe l:txtBOL . g:pdv_cfg_Comment1 . " default comment." . g:pdv_cfg_EOL
